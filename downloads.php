    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right toggle-menu">
				...
				<li><a href="downloads">Mobile App</a></li>
...
<section class="section-padding has-parallax our-media">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="media-subtitle">Apps Downloads</p>
            </div>
            <div class="btn-position">
                <div class="tab-position">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="tabset-left active" role="presentation"><a href="#audio" aria-controls="audio" role="tab" data-toggle="tab">Mobile</a></li>
                        <li class="tabset-right" role="presentation"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">Desktop</a></li>
                    </ul>
                </div>
                <!-- Tab panes -->
                        ...
                        <div class="audio-wrap">
                            <div class="col-xs-12 col-sm-8 col-md-9">
                                <div class="audio-title">
                                    ...
                                    <p>Live Dunamis Radio On Android</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3 col-md-2">
                                <div class="audio-buy">
                                    <a href="#" class="btn btn-defualt">Download Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="audio-wrap">
                            <div class="col-xs-12 col-sm-8 col-md-9">
                                <div class="audio-title">
                                    ...
                                    <p>Live Dunamis Radio On iOS</p>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-3 col-md-2">
                                <div class="audio-buy">
                                    <a download="Nare Ekele - Dr Paul Enenche | Dunamis Radio" href="#" class="btn btn-defualt">Download Now</a>
                                </div>
                            </div>
                        </div>
