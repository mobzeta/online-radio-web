                            ...
                            <div class="header-slide">
                                <div class="hero-wrap">
                                    <div class="no-overflow">
                                            ...
                                            <h1>Welcome to Dunamis Live Radio</h1>
                                            <h1>...impacting your world</h1>
                                            <span class="attr">DIGC</span>
                            ...
                            <div class="header-slide">
                                <div class="hero-wrap">
                                    <div class="no-overflow">
                                            ...
                                            <h1>The right place to feel the God's presence</h1>
                                            <span class="attr"> &mdash; Revelation</span>
                            ...
                            <div class="header-slide">
                                <div class="hero-wrap">
                                    <div class="no-overflow">
                                            ...
                                            <h1>I can't go a day without</h1>
                                            <h1> listening to dunamis radio</h1>
                                            <span class="attr"> &mdash; Revelation</span>
