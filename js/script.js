...
$(function() {
    ...
    if ($('.audio-player').length) {
        ...
        var myPlaylist = new jPlayerPlaylist({
            ...
            title: "Dunamis Live Radio",
            artist: "Dunamis International Gospel Center",
            mp3: "http://edge.mixlr.com/channel/wycna",
            oga: "http://edge.mixlr.com/channel/wycna"
        }], {
            swfPath: "js/plugins",
            supplied: "oga, mp3",
            wmode: "window",
            ...
            keyEnabled: true,
            playlistOptions: {
                autoPlay: true // Change to true to start playing songs on page load
            }
